...
2. Import into your IDE (eclipse)
3. Main is defined in com.theater.seating.main.InitiateSeating.java
4. Running this project will provide instructions to give inputs, in console.

This project is intended to solve problem.
